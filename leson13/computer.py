...
def saveData(topic:str,value:int|float|str):
    ...
    #3. 將參數的資料儲存至csv檔案內
    #parameter 1 : topic:str -> 訂閱資料名稱
    #parameter 2 : value:int or float -> 訂閱資料數值
    '''
    root_dir=os.getcwd()
...
def on_message(mosq, obj, msg):
    ...
    elif msg.topic=="SA-58/Temperature":
    ...
    elif msg.topic=="SA-58/switch":
        switch=int(msg.payload.decode('utf-8'))
        if switch_origin_value!=switch:
            switch_origin_value=switch
